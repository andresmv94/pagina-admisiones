...
include('/home/servidor/apache/htdocs/html/new/uso_public/paraformularios.php');
  ...
  a[href]:after {
    content: none !important;
		...
		<? head('Área de Admisiones - Pregrado Cali', '<link rel="stylesheet" href="../chatbot/principalChatbot.css"></link><link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css"></link>'); ?>
	  ...
	  <div class="row">	
		 <div class="col-md-8 col-md-offset-2">	
			...
			<? migadepan("<a href='https://admisiones.univalle.edu.co/new/_new/interior/'>Primer Semestre - CALI</a>"); ?>
		</div>
	  </div>		
			<? 
			...
			if(accesoIP() && $ip != '192.168.248.236' || $ip == '192.168.9.3'){
				...
				/*
				$estadisticas_pregrado ="<a href='#' onclick=\"mostrarcontenido('$manual','$val');\"><b>Manual</b></a>";

				<a href="http://admisiones.univalle.edu.co/new/estadisticas.php" type="button" class="btn btn-univalle btn-xs">
					<font size="4" color="#FFF">
						<i class="fa fa-bar-chart" aria-hidden="true"></i>
					</font>
					<font color="#FFF"><b>Estadísticas Pregrado Cali</b></font>
				</a>
				*/
        ...
        $oferta_s = 'oferta';
        $oferta_Cali = "<a href='#' onclick=\"mostrarcontenido('$oferta_s','$val');\"><b>Oferta Academica 2022-I</b></a>";
        $calendario_Cali = "<a href='#' onclick=\"mostrarcontenido('$calendario','$val');\"><b>Fechas del proceso 2022-I</b></a>";
        $manual_Cali ="<a href='#' onclick=\"mostrarcontenido('$manual','$val');\"><b>Manual 2022-I</b></a>";
      ...
      if(accesoIP() && $ip != '192.168.248.236' || $ip == '192.168.9.3' ){
										 ...
										 //  $citas_p,
										  ...
										  "<a href='http://admisiones.univalle.edu.co/new/_new/interior/aspirantereserva2/' target='_blank'>Carga de Reserva de Cupo</a>",
										   ...
										   "<a href='http://admisiones.univalle.edu.co/new/_new/reinscripcion/' ><b>reinscripcion new</b></a>",
										   	"<a href='http://admisiones.univalle.edu.co/new/estadisticas.php' ><b>Estadisticas Pregrado</b></a>",
				...
				$arrayMenu = array(
											 ...
											 "<a href='https://sira.univalle.edu.co/sra/paquetes/admisiones/preinscripcion/login.php' target='_blank'><font size='2'><B>Inscripción</B></font></a>",
			...
			function resmensaje(){
				swal({
					title:"Información importante",
						...
						type: 'info',
						width: '80rem',
						text:'\n\nLas Respuesta Reserva de Cupo se publicarán el día 2 de septiembre de 2021, en horas de la tarde. \n\n ',				  
						});
			}
